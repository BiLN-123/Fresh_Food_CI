<div class="content-wrapper">
	...
	<div class="content">
		<div class="container-fluid">
			<div class="row">
				<div class="col-md-12 ">
					<a href="<?= admin_url('slider/trash')?>" class="btn btn-default float-right"><i class="fa fa-trash"></i> Thùng rác</a>
					...
					<table class="table">
						...
						<tr>
							...
							<td>
								...
								<a href="<?= admin_url('slider/deleted_at/'.$slider->id)?>" class="btn btn-danger" onclick="return confirm('Bạn có muốn xoá không?');" id="deleted_at"><i class="fa fa-trash"></i> Xoá</a>
							</td>
						</tr>
						<?php endforeach;?>
						</tbody>
